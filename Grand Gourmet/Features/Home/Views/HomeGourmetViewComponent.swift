...
extension HomeGourmetViewComponent {
                ...
                ForEach(list.items, id: \.id) { (gourmet: GourmetItem) in
                    ...
                    VStack(alignment: .leading) {
                        ...
                        ZStack(alignment: .topTrailing) {
                            // https://github.com/SDWebImage/SDWebImageSwiftUI/issues/172
                            LazyReleaseableWebImage {
                                webImageViewComponent(urlString: gourmet.imageURL)
                            } placeholder: {
                                webImagePlaceholder(text: gourmet.name)
                            }
    ...
    func webImagePlaceholder(text: String) -> some View {
        VStack {
            ProgressView()
    ...
    func webImageViewComponent(urlString: String) -> WebImage {
        WebImage(url: URL(string: urlString))
            .resizable()
            .placeholder(.init(systemName: "circle.dashed"))
    }
}
